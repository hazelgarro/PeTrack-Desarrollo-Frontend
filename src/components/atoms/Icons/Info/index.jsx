export default function Info({ iconName, color}) {
    const icons = {
        ...
        age: <svg className={`text-${color}`} xmlns="http://www.w3.org/2000/svg" width="2em" height="2em" viewBox="0 0 24 24"><g fill="none" fill-rule="evenodd">
        ...
        weight: <svg className={`text-${color}`} xmlns="http://www.w3.org/2000/svg" width="2em" height="2em" viewBox="0 0 48 48"><g fill="currentColor" fill-rule="evenodd" clip-rule="evenodd">
