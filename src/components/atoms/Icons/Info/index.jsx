import "../styles.css";
 ...
 export default function Info({ iconName, color}) {
    const icons = {
        dog: <svg className={`text-${color}`} xmlns="http://www.w3.org/2000/svg" width="2em" height="2em" viewBox="0 0 256 256">
        ...
        cat: <svg className={`text-${color}`} xmlns="http://www.w3.org/2000/svg" width="2em" height="2em" viewBox="0 0 24 24">
        ...
        male: <svg className={`text-${color}`} xmlns="http://www.w3.org/2000/svg" width="2em" height="2em" viewBox="0 0 24 24">
        ...
        female: <svg className={`text-${color}`} xmlns="http://www.w3.org/2000/svg" width="2em" height="2em" viewBox="0 0 24 24">
        ...
        location: <svg className={`text-${color}`} xmlns="http://www.w3.org/2000/svg" width="2em" height="2em" viewBox="0 0 24 24"><g fill="none" stroke="currentColor" stroke-linejoin="round">
