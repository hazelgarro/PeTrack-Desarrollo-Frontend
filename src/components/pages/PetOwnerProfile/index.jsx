            ...
            <body className="relative mb-12 2xl:mx-80 xl:mx-60 lg:mx-40 md:mx-24 mx-4 my-5">
                ...
                <div className="flex flex-col md:flex-row gap-8 mb-10">
                    ...
                    <div className="flex flex-col justify-center text-center md:text-left">
                        <h1 className="text-petrack-green text-4xl md:text-6xl font-bold mb-2">Name</h1>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-12 mb-4">
                    <div>
                        <p className="text-center sm:text-left">User type</p>
                    ...
                    <div>
                        <p className="text-center sm:text-left">Phone number</p>
                        <div className="flex justify-center sm:justify-start gap-2 items-center">
                            <IconExit></IconExit>
                ...
                <div>
                    <p className="flex text-petrack-green text-2xl md:text-3xl font-bold mt-12 md:mt-24 mb-6 text-center">My pets</p>
                </div>
                <div>
